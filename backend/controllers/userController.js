...
import doctorModel from '../models/doctorModdel.js'
...
const loginUser = async (requestAnimationFrame, res) => {
    ...
    try {
        ...
        if (!user) {
            return res.json({ success: false, message: 'User doas not exit' })
        }
...
const cancelAppointment = async (req, res) => {
    ...
    try {
        ...
        if (appointmentData.userId !== userId) {
            return res.json({ success: false, message: 'Unauthorrized action' })
        }
        ...
        slots_booked[slotDate] = slots_booked[slotDate].fillter(e => e !== slotTime)
...
const paymentRazorpay = async (req, res) => {
    ...
    try {
        ...
        //creating options for pazorpay payment
        const options = {
